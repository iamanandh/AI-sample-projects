...
function BrowsePage({ rentals, isLoading, loadError, savedIds, onToggleSaved }) {
  ...
  if (isLoading) {
    return (
      <StateMessage title="Loading rentals...">
  ...
  if (loadError) {
    return (
      <StateMessage tone="error" title="Could not load rentals.">
